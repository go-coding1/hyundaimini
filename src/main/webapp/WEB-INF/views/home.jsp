...
<html lang="ko">
<head>
<meta name="naver-site-verification" content="2f9358e1e36605519854a595f243f0171519dd1d"/resources/>
...
<meta http-equiv="pragma" content="no-cache"/resources/>
<meta http-equiv="Cache-Control" content="No-Cache"/resources/>
...
<script type="text/javascript">
		...
		var ACC = { config: {} };
			...
			ACC.config.encodedContextPath = "/resources/ko";
			...
			ACC.config.CSRFToken = "ef80554f-35d8-49d0-9154-b186d4566a0c";
...
<script type="text/javascript">
    var handsomeContextPath = "/resources/ko"; 
</script>
 
<script type="text/javascript" src="/resources/_ui/desktop/common/js/handsome/common.js"></script>
<script type="text/javascript" src="/resources/_ui/desktop/common/js/handsome/html5shiv-printshiv.js"></script>
<script type="text/javascript" src="/resources/_ui/desktop/common/js/handsome/jquery.flexslider.js"></script>
<script type="text/javascript" src="/resources/_ui/desktop/common/js/handsome/ui.js"></script>
<script type="text/javascript" src="/resources/_ui/desktop/common/js/jquery.form-3.51.js"></script>
<script type="text/javascript" src="/resources/_ui/desktop/common/js/common_function.js"></script>
<script type="text/javascript" src="/resources/_ui/desktop/common/js/videojs-ie8.min.js"></script>
<!--[if lt IE 9]>
...
<script type="text/javascript" src="/resources/_ui/desktop/common/js/jquery-ui-1.11.2.min.js"></script>

<script type="text/javascript" src="/resources/_ui/desktop/common/js/instagramAPI.js"></script>
<script type="text/javascript" src="/resources/_ui/desktop/common/js/instagramAPI.js"></script>
<script type="text/javascript" src="/resources/_ui/desktop/common/js/handsome/jquery.bxslider.min.js"></script>
<script type="text/javascript" src="/resources/_ui/desktop/common/js/makePCookie.js"></script>

<script type="text/javascript" src="/resources/_ui/shared/js/siteoverlay.js"></script>
<script type="text/javascript" src="/resources/_ui/desktop/common/wisenut/js/jquery.min.js"></script>

<script type="text/javascript" src="/resources/_ui/desktop/common/js/swiper.min.js"></script>
<script type="text/javascript" src="/resources/_ui/desktop/common/js/netfunnel.js" charset="UTF-8"></script>
<script type="text/javascript" src="/resources/_ui/desktop/common/js/netfunnel_skin.js" charset="UTF-8"></script>

<script type="text/javascript" src="/resources/_ui/desktop/common/js/unorm.js"></script>

<script type="text/javascript" src="/resources/_ui/desktop/common/js/appboy.min.js"></script>
<script type="text/javascript">
var setDimensionData = function(){
    ...
    // 검색 결과 페이지 일 경우만 처리
    if(window.location.pathname.indexOf("/resources/hssearch/searchCount") > -1) {
...
function getPageDepth(){
    ...
    if(target_url.substring(target_url.indexOf("/resources/ko/")+4) == ""){
        returnDepth = "메인";
    }else if(target_url.substring(target_url.indexOf("/resources/ko")+3) == ""){
        returnDepth = "메인";
    }else if(target_url.indexOf("/resources/p/") > -1){
        returnDepth = "상품상세";
    }else if(target_url.indexOf("/resources/b/fourmMain") > -1){
        returnDepth = "브랜드";
    }else if(target_url.indexOf("/resources/b/storeInformation") > -1){
        returnDepth = "매장안내";
    }else if(target_url.indexOf("/resources/b/") > -1){
    	
    	if(target_url.toLowerCase().substring(target_url.indexOf("/resources/c/")+3).indexOf("br") > -1){
    		returnDepth = "브랜드";
    	}else{
    		returnDepth = "";
    	}
		
    }else if(target_url.indexOf("/resources/c/ou_") > -1){
        returnDepth = "아울렛";
    }else if(target_url.indexOf("/resources/c/") > -1){
        // if'/c/카테고리코드' : /가 한개면
    ...
    }else if(target_url.indexOf("/resources/mypage") > -1){
        returnDepth = "마이페이지";
    }else if(target_url.indexOf("/resources/magazine/events") > -1){
        returnDepth = "이벤트";
    }else if(target_url.indexOf("/resources/magazine/") > -1){
        returnDepth = "매거진";
    }else if(target_url.indexOf("/resources/shoppingbag") > -1){
        returnDepth = "쇼핑백";
    }else if(target_url.indexOf("/resources/ou/") > -1){
        returnDepth = "아울렛";
    }else if(target_url.indexOf("/resources/checkout/") > -1){
        returnDepth = "주문";
    }else if(target_url.indexOf("/resources/member/") > -1){
        returnDepth = "로그인";
    }else if(target_url.indexOf("/resources/login/") > -1){
        returnDepth = "로그인";
    }else if(target_url.indexOf("/resources/sns/") > -1){
        returnDepth = "SNS";
    }else if(target_url.indexOf("/resources/prodqna/") > -1){
        returnDepth = "상품Q&A";
    }else if(target_url.indexOf("/resources/svcenter/") > -1){
        returnDepth = "고객센터";
    }else if(target_url.indexOf("/resources/item/") > -1){
        returnDepth = "아이템";
    }else if(target_url.indexOf("/resources/store-finder/") > -1){
        returnDepth = "매장안내";
    }else if(target_url.indexOf("/resources/footer/") > -1){
        returnDepth = "FOOTER";
    }else if(target_url.indexOf("/resources/appDownloadSMS/") > -1){
        returnDepth = "APP 다운로드";
    }else if(target_url.indexOf("/resources/intro/") > -1){
        returnDepth = "당신만의 한섬";
    }else if(target_url.indexOf("/resources/mobilecommon/mainIntro") > -1){
        returnDepth = "공통";
    }else if(target_url.indexOf("/resources/mobilecommon/search") > -1){
        returnDepth = "공통";
    }else if(target_url.indexOf("/resources/hssearch") > -1){
        returnDepth = "검색";
    }else if(target_url.indexOf("/resources/product/") > -1){
        returnDepth = "상품";
    }else if(target_url.indexOf("/resources/globalMain") > -1){
        returnDepth = "메인";
    }else if(target_url.indexOf("/resources/main") > -1){
        returnDepth = "메인";
    }else{
        returnDepth = "";
    }
...
function getGAPageTitle(oneDepthPage){
    ...
    //if(target_url.substring(target_url.indexOf("/resources/ko/")+4).indexOf("/resources/") == -1){
    if(target_url.substring(target_url.indexOf("/resources/ko/")+4) == ""){
        ...
        returnTitle = oneDepthPage;
    }else if(target_url.indexOf("/resources/b//brand") > -1){
        returnTitle = oneDepthPage+">>소개";
    }else if(target_url.indexOf("/resources/b//storeInformation") > -1){
        returnTitle = oneDepthPage+">>매장";
    }else if(target_url.indexOf("/resources/b/lookBookDetail?") > -1){
        returnTitle = oneDepthPage+">룩북>상세>";
    }else if(target_url.indexOf("/resources/b/lookBook") > -1){
        returnTitle = oneDepthPage+">룩북>리스트";
    }else if(target_url.indexOf("/resources/b//lookBookDetail?lookBookCode=") > -1){
        returnTitle = oneDepthPage+">>룩북>";
    }else if(target_url.indexOf("/resources/b//lookBook") > -1){
        returnTitle = oneDepthPage+">>룩북";
    }else if(target_url.indexOf("/resources/b/") > -1){
        returnTitle = oneDepthPage+">>브랜드 메인";
    }else if(target_url.indexOf("/resources/c//ou") > -1){
    	returnTitle = oneDepthPage;
    ...
    }else if(target_url.indexOf("/resources/mypage/order/myordersAthome") > -1){
        returnTitle = oneDepthPage+">앳홈신청 및 결제";
    }else if(target_url.indexOf("/resources/mypage/order/myorders") > -1){
        returnTitle = oneDepthPage+">주문/배송조회";
    }else if(target_url.indexOf("/resources/mypage/myGradeInfo") > -1){
        returnTitle = oneDepthPage+">나의 회원등급";
    }else if(target_url.indexOf("/resources/mypage/voucher") > -1){
        returnTitle = oneDepthPage+">쿠폰";
    }else if(target_url.indexOf("/resources/mypage/mypoint") > -1){
        returnTitle = oneDepthPage+">혜택관리>나의 한섬마일리지";
    }else if(target_url.indexOf("/resources/mypage/myEGiftCard") > -1){
        returnTitle = oneDepthPage+">혜택관리>e-giftcard";
    }else if(target_url.indexOf("/resources/mypage/myWish") > -1){
        returnTitle = oneDepthPage+">위시리스트";
    }else if(target_url.indexOf("/resources/mypage/rsalarm") > -1){
        returnTitle = oneDepthPage+">재입고 알림";
    }else if(target_url.indexOf("/resources/mypage/personInfomationChangePWCheck") > -1){
        returnTitle = oneDepthPage+">개인정보 변경/탈퇴";
    }else if(target_url.indexOf("/resources/mypage/mydelivery") > -1){
        returnTitle = oneDepthPage+">배송지 관리";
    }else if(target_url.indexOf("/resources/mypage/oneClick") > -1){
        returnTitle = oneDepthPage+">나의 정보관리>원클릭 결제 관리";
    }else if(target_url.indexOf("/resources/mypage/myreview") > -1){
        returnTitle = oneDepthPage+">내 상품평";
    }else if(target_url.indexOf("/resources/mypage/myqna") > -1){
        returnTitle = oneDepthPage+">상품 Q&A";
    }else if(target_url.indexOf("/resources/mypage/mymantomaninquiry") > -1){
        returnTitle = oneDepthPage+">1:1 문의";
    }else if(target_url.indexOf("/resources/mypage/mypageFloatingPopup") > -1){
        returnTitle = oneDepthPage+">메인";
    }else if(target_url.indexOf("/resources/mypage/mypoint/mobile") > -1){
        returnTitle = oneDepthPage+">나의 혜택";
    }else if(target_url.indexOf("/resources/mypage/event/myevents") > -1){
        returnTitle = oneDepthPage+">나의 이벤트";
    }else if(target_url.endsWith("/resources/ko/mypage/", target_url.length)){
        returnTitle = oneDepthPage+">메인";
    }else if(target_url.endsWith("/resources/ko/mypage", target_url.length)){
        returnTitle = oneDepthPage+">메인";
    }else if(target_url.indexOf("/resources/magazine/events/") > -1){
    ...
    }else if(target_url.indexOf("/resources/magazine/editorials/") > -1){
        returnTitle = oneDepthPage+">에디토리얼>상세>";
    }else if(target_url.indexOf("/resources/magazine/editorials") > -1){
        returnTitle = oneDepthPage+">에디토리얼>리스트";
    }else if(target_url.indexOf("/resources/magazine/exhibitions/") > -1){
        returnTitle = oneDepthPage+">기획전>상세>";
    }else if(target_url.indexOf("/resources/magazine/exhibitions") > -1){
        returnTitle = oneDepthPage+">기획전>리스트";
    }else if(target_url.indexOf("/resources/magazine/handpeople") > -1){
        returnTitle = oneDepthPage+">핸썸피플 리스트";
    }else if(target_url.indexOf("/resources/magazine/instagram") > -1){
        returnTitle = oneDepthPage+">인스타그램";
    }else if(target_url.indexOf("/resources/magazine/lookbookDetail/") > -1){
        returnTitle = oneDepthPage+">룩북>상세>";
    }else if(target_url.indexOf("/resources/magazine/lookbook") > -1){
        returnTitle = oneDepthPage+">룩북>리스트";
    }else if(target_url.indexOf("/resources/magazine/newsDetailtemplatetype") > -1){
        returnTitle = oneDepthPage+">뉴스>상세>";
    }else if(target_url.indexOf("/resources/magazine/news") > -1){
        returnTitle = oneDepthPage+">뉴스>리스트";
    }else if(target_url.indexOf("/resources/magazine/weeklypick") > -1){
        returnTitle = oneDepthPage+">위클리픽 리스트";
    }else if(target_url.indexOf("/resources/magazine/submain") > -1){
        returnTitle = oneDepthPage+">THE매거진 메인";
    }else if(target_url.indexOf("/resources/magazine/youtubeList") > -1){
        returnTitle = oneDepthPage+">비디오";
    }else if(target_url.indexOf("/resources/shoppingbag") > -1){
        returnTitle = oneDepthPage;
    }else if(target_url.indexOf("/resources/ou/outletMain") > -1){
        returnTitle = oneDepthPage+">메인";
    }else if(target_url.indexOf("/resources/c/ou_/ou") > -1){
        returnTitle = oneDepthPage+">";
    }else if(target_url.indexOf("/resources/mobilecommon/search") > -1){
        returnTitle = oneDepthPage+">키워드";
    }else if(target_url.indexOf("/resources/hssearch/") > -1){
        returnTitle = oneDepthPage+">검색결과";
    }else if(target_url.indexOf("/resources/checkout/ordersheet") > -1){
        returnTitle = oneDepthPage+">주문서 작성";
    }else if(target_url.indexOf("/resources/checkout/orderConfirmation") > -1){
        returnTitle = oneDepthPage+">주문 완료";
    }else if(target_url.indexOf("/resources/member/login") > -1){
        returnTitle = oneDepthPage;
    }else if(target_url.indexOf("/resources/login/checkout") > -1){
        returnTitle = oneDepthPage+">미로그인시로그인유도";
    }else if(target_url.indexOf("/resources/member/pwChange") > -1){
        returnTitle = oneDepthPage+">비밀번호 변경 대상";
    }else if(target_url.indexOf("/resources/member/findIdPwPage") > -1){
        returnTitle = oneDepthPage+">한섬회원 아이디/비밀번호 찾기";
    }else if(target_url.indexOf("/resources/member/globaljoincomplete") > -1){
        returnTitle = oneDepthPage+">가입완료";
    }else if(target_url.indexOf("/resources/member/joincomplete") > -1){
        returnTitle = oneDepthPage+">가입완료";
    }else if(target_url.indexOf("/resources/member/joinGuidePage") > -1){
        returnTitle = oneDepthPage+">회원가입안내";
    }else if(target_url.indexOf("/resources/member/joininfoform") > -1){
        returnTitle = oneDepthPage+">간편회원 정보입력";
    }else if(target_url.indexOf("/resources/member/joinstart") > -1){
        returnTitle = oneDepthPage+">간편회원 이메일";
    }else if(target_url.indexOf("/resources/member/nonMemberLogin") > -1){
        returnTitle = oneDepthPage+">비회원 주문조회";
    }else if(target_url.indexOf("/resources/sns/main") > -1){
        returnTitle = oneDepthPage+">메인";
    }else if(target_url.indexOf("/resources/sns/detail?") > -1){
        returnTitle = oneDepthPage+">포스트상세보기";
    }else if(target_url.indexOf("/resources/sns/myNotice") > -1){
        returnTitle = oneDepthPage+">나의알림";
    }else if(target_url.indexOf("/resources/sns/collectionDetail?") > -1){
        returnTitle = oneDepthPage+">콜렉션상세";
    }else if(target_url.indexOf("/resources/sns/followerList?") > -1){
        returnTitle = oneDepthPage+">팔로워리스트";
    }else if(target_url.indexOf("/resources/sns/followingList?") > -1){
        returnTitle = oneDepthPage+">팔로윙리스트";
    }else if(target_url.indexOf("/resources/sns/snsSearch?searchWord=") > -1){
        returnTitle = oneDepthPage+">태그검색";
    }else if(target_url.indexOf("/resources/sns/message?") > -1){
        returnTitle = oneDepthPage+">메시지";
    }else if(target_url.indexOf("/resources/sns/messageList") > -1){
        returnTitle = oneDepthPage+">메시지리스트";
    }else if(target_url.indexOf("/resources/sns/myLevel") > -1){
        returnTitle = oneDepthPage+">나의레벨";
    }else if(target_url.indexOf("/resources/sns/myProfile?") > -1){
        returnTitle = oneDepthPage+">나의프로필";
    }else if(target_url.indexOf("/resources/sns/weeklyBest") > -1){
        returnTitle = oneDepthPage+">위클리베스트";
    }else if(target_url.indexOf("/resources/sns/write") > -1){
        returnTitle = oneDepthPage+">포스팅작성";
    }else if(target_url.indexOf("/resources/mobilecommon/mainIntro") > -1){
        returnTitle = oneDepthPage+">인트로";
    }else if(target_url.indexOf("/resources/svcenter/submain") > -1){
        returnTitle = oneDepthPage+">서브메인";
    }else if(target_url.indexOf("/resources/svcenter/notice") > -1){
        returnTitle = oneDepthPage+">공지사항";
    }else if(target_url.indexOf("/resources/svcenter/mantomaninquiry") > -1){
        returnTitle = oneDepthPage+">1:1 문의";
    }else if(target_url.indexOf("/resources/svcenter/faq") > -1){
        returnTitle = oneDepthPage+">FAQ";
    }else if(target_url.indexOf("/resources/svcenter/mending") > -1){
        returnTitle = oneDepthPage+">수선진행조회";
    }else if(target_url.indexOf("/resources/svcenter/memberjoinguide") > -1){
        returnTitle = oneDepthPage+">쇼핑가이드>회원가입";
    }else if(target_url.indexOf("/resources/svcenter/theClubInfo") > -1){
        returnTitle = oneDepthPage+">쇼핑가이드>온라인 멤버십";
    }else if(target_url.indexOf("/resources/svcenter/memberbenefitguide") > -1){
        returnTitle = oneDepthPage+">쇼핑가이드>한섬 VVIP 혜택";
    }else if(target_url.indexOf("/resources/svcenter/pointguide") > -1){
        returnTitle = oneDepthPage+">쇼핑가이드>한섬마일리지 혜택";
    }else if(target_url.indexOf("/resources/svcenter/couponguide") > -1){
        returnTitle = oneDepthPage+">쇼핑가이드>쿠폰";
    }else if(target_url.indexOf("/resources/svcenter/asguide") > -1){
        returnTitle = oneDepthPage+">쇼핑가이드>배송/반품/AS";
    }else if(target_url.indexOf("/resources/svcenter/paymentguide") > -1){
        returnTitle = oneDepthPage+">쇼핑가이드>주문/결제";
    }else if(target_url.indexOf("/resources/svcenter/athomeInfo") > -1){
        returnTitle = oneDepthPage+">at HOME";
    }else if(target_url.indexOf("/resources/svcenter/footerAthomeInfo") > -1){
        returnTitle = oneDepthPage+">딜리버리서비스";
    }else if(target_url.indexOf("/resources/svcenter/mobilemain") > -1){
        returnTitle = oneDepthPage+">메인";
    }else if(target_url.indexOf("/resources/svcenter/mobilenotice") > -1){
        returnTitle = oneDepthPage+">공지사항";
    }else if(target_url.indexOf("/resources/svcenter/mobilefaq") > -1){
        returnTitle = oneDepthPage+">FAQ";
    }else if(target_url.indexOf("/resources/svcenter/mobilemending") > -1){
        returnTitle = oneDepthPage+">수선진행조회";
    }else if(target_url.indexOf("/resources/svcenter/serviceguide?targetSlide=0") > -1){
        returnTitle = oneDepthPage+">서비스소개>간편서비스";
    }else if(target_url.indexOf("/resources/svcenter/serviceguide?targetSlide=1") > -1){
        returnTitle = oneDepthPage+">서비스소개>스마트쇼핑";
    }else if(target_url.indexOf("/resources/svcenter/serviceguide?targetSlide=2") > -1){
        returnTitle = oneDepthPage+">서비스소개>유니크한섬";
    }else if(target_url.indexOf("/resources/svcenter/serviceguide") > -1){
        returnTitle = oneDepthPage+">서비스소개";
    }else if(target_url.indexOf("/resources/item/we") > -1){
        returnTitle = oneDepthPage+">WE";
    }else if(target_url.indexOf("/resources/item/me") > -1){
        returnTitle = oneDepthPage+">ME";
    }else if(target_url.indexOf("/resources/store-finder/") > -1){
        returnTitle = oneDepthPage;
    }else if(target_url.indexOf("/resources/footer/footerBrandintro") > -1){
        returnTitle = oneDepthPage+">브랜드소개";
    }else if(target_url.indexOf("/resources/footer/footerCompanyIntro") > -1){
        returnTitle = oneDepthPage+">회사소개>한섬소개";
    }else if(target_url.indexOf("/resources/footer/footerCEOGreetings") > -1){
        returnTitle = oneDepthPage+">회사소개>CEO 메시지";
    }else if(target_url.indexOf("/resources/footer/footerBrandintro") > -1){
        returnTitle = oneDepthPage+">회사소개>브랜드소개";
    }else if(target_url.indexOf("/resources/footer/footerGovernance") > -1){
        returnTitle = oneDepthPage+">투자정보>기업지배구조";
    }else if(target_url.indexOf("/resources/footer/footerFinancialInfo") > -1){
        returnTitle = oneDepthPage+">투자정보>재무정보";
    }else if(target_url.indexOf("/resources/footer/footerStockInfo") > -1){
        returnTitle = oneDepthPage+">투자정보>주가정보";
    }else if(target_url.indexOf("/resources/footer/footerIR") > -1){
        returnTitle = oneDepthPage+">투자정보>IR";
    }else if(target_url.indexOf("/resources/footer/footerCorporatePartnership") > -1){
        returnTitle = oneDepthPage+">동반성장>소개";
    }else if(target_url.indexOf("/resources/footer/footerCoreFourPractices") > -1){
        returnTitle = oneDepthPage+">동반성장>4대 실천사항";
    }else if(target_url.indexOf("/resources/footer/footerCooperatorSelection") > -1){
        returnTitle = oneDepthPage+">동반성장>협력업체 선정";
    }else if(target_url.indexOf("/resources/footer/footerSupportProgram") > -1){
        returnTitle = oneDepthPage+">동반성장>지원제도";
    }else if(target_url.indexOf("/resources/footer/footerContactUs") > -1){
        returnTitle = oneDepthPage+">동반성장>소통의 장";
    }else if(target_url.indexOf("/resources/appDownloadSMS/") > -1){
        returnTitle = oneDepthPage;
    }else if(target_url.indexOf("/resources/intro/mainYours") > -1){
        returnTitle = oneDepthPage;
    }else if(target_url.indexOf("/resources/globalMain") > -1){
        returnTitle = oneDepthPage;
    }else if(target_url.indexOf("/resources/main") > -1){
...
try{
	...
	(function(w,d,n,s,e,o) {
	  ...
	  e=d.createElement(s);e.async=1;e.charset='utf-8';e.src='/resources//static.recopick.com/dist/production.min.js';
...
<noscript>
    <img height="1" width="1" style="display:none" src="https://www.facebook.com/tr?id=1947530058811697&ev=PageView&noscript=1"/resources/>
</noscript>
<!-- End Facebook Pixel Code -->

        <!-- #2894 - 카카오광고 집행 위한 픽셀&SDK 삽입 -->
<script type="text/javascript" charset="UTF-8" src="/resources//t1.daumcdn.net/adfit/static/kp.js"></script>
<script type="text/javascript">
...
<!-- <div id="transparent_mask"></div> -->
	...
	<div class="loading_bar" id="loadingBarDiv" style="display:none;">
		<img src="/resources/_ui/desktop/common/images/common/loading.gif" alt="loading"/resources/>
		<span>�로딩중</span>
	</div>
	<!-- //Loading -->

	<form id="CSRFForm" action="/resources/ko/" method="post"><div>
<input type="hidden" name="CSRFToken" value="ef80554f-35d8-49d0-9154-b186d4566a0c" />
</div></form><!-- headerWrap -->
		<div id="headerWrap" >
...
function callChatbot(token, talkId) {
    if(token == null) {
        $.ajax({
            type:"POST",
            url:"/resources/ko/chatbot/token",
            data: {"CSRFToken":"ef80554f-35d8-49d0-9154-b186d4566a0c"},
            async : false,
            success:function(data){
                if(data.result == "SHOULD_LOGIN") {
                    var la = new layerAlert("로그인이 필요합니다");
                    la.confirmAction = function(){//확인 버튼 클릭시 추가 호출 펑션
                        location.href = "/resources/ko/member/login";
                    };
                }
...
<script type="text/javascript" src="/resources/_ui/desktop/common/wisenut/ark/js/beta.fix.js"></script>
<script type="text/javascript" src="/resources/_ui/desktop/common/wisenut/ark/js/ark.js"></script>
<script type="text/javascript" src="/resources/_ui/desktop/common/wisenut/js/search.js"></script>
<script type="text/javascript">
//<![CDATA[
    // #1067 - 201803 메인 개편
    function applyCategory(){
        ...
        $.ajax({
            type:"GET",
            url:"/resources/intro/setCategoryList",
...
$(document).ready(function() {
	...
	$('#gnbsearch').click(function () {
		...
		if(searchwords!=""){
			location.href="/resources/ko/hssearch?searchwords="+searchwords;
		}else{
			$('#gnbsearchwords').val("");
			alert("검색어를 입력해주세요.");
		}
	...
	$('.favBtn').click(function(){
		...
		words = $(this).text();
		location.href="/resources/ko/hssearch?searchwords="+words;
    ...
    if("" != ""){
	    ...
	    if(vipPassCheck == "N" && "" == "PASS"){ // MANIA 이하 등급, 평일 체크 
	        ...
	        if(weekName != "일요일" && weekName != "토요일" && hour >= "0900" && hour <= "1800"){
	            $.ajax({
	                type:"POST",
	                url:"/resources/ko/chatbot/chkholiday",
	                data: {"CSRFToken":"ef80554f-35d8-49d0-9154-b186d4566a0c"},
	                async : false,
...
function language(isoCode) {
	if(location.href.indexOf("/resources/handsome/") > -1){
		
			$.ajax({ 
				type : "post", 
				url : "/resources/ko/_s/language" + "?" + "code="+isoCode,
				dataType : "json",
				error : function( request, status, error ){				
					console.log( "code:" + request.status+"\n" + "message:" + request.responseText+"\n" + "error:" + error );
				}, 
				success : function( result ){
					location.href = "/resources/ko/";
				}
			});
...
function setLogout(){
    ...
    location.href = "/resources/ko/logout";
}
...
<form id="autologinForm" name="autologinForm" action="/resources/ko/hp/autologin"  method="get">
    <input type="hidden" name="hcid" id="hcid" value="e2gaf@naver.com" />
		...
		<div class="top_nav topnav1903">
            ...
            <ul class="clearfix">
                <!-- 선호 브랜드 없음 -->
                        <li><span class="on"><a href="/resources/ko/main" onclick="GA_Event('공통','탑_네비게이션','HOME')">HOME</a></span></li>
                        <!-- 로그인 상태 -->
								<!-- 비로그인 상태 -->
    ...
    <div class="gnb_sh_wrap" style="display:none;">
					...
					<div class="gnb_sh_box">
						<input type="text" class="input" id="gnbsearchwords" title="검색어 입력" value=""  onkeypress="if(event.keyCode==13) {EnterSearchHeader(); return false;}"/resources/>
                ...
                >
                    <form name="search" id="search" action="/resources/ko/hssearch/searchCount" method="post" onsubmit="return false;">           
                        <input type="hidden" name="CSRFToken" value="ef80554f-35d8-49d0-9154-b186d4566a0c" />
                    ...
                    <div class="data_react">
                        ...
                        <div class="search_tab">
                            ...
                            <!-- style search -->
                            <form id="searchStyle" name="searchStyle" action="/resources/ko/hssearch/searchCount" method="post" onsubmit="return false;">
                                <input type="hidden" name="query" value=""/resources/>
                                <input type="hidden" name="collection" value=""/resources/>
                                <input type="hidden" id="CSRFToken" name="CSRFToken" value="ef80554f-35d8-49d0-9154-b186d4566a0c" />
                                <input type="hidden" id="searchStyleYn" name="searchStyleYn" value="searchStyle"/resources/>
                            </form>
...
<!--                                     <p><span>"<span id="autocomplete_query"></span>&#32;"</span>에 대한 주요 검색 결과</p> -->
                ...
                <div class="util_menu" style="display:block;">
					<ul class="clearfix">
						<li><a href="/resources/ko/member/login" onclick="GA_Event('공통','헤더_메뉴','로그인')">로그인<!-- 로그인 --></a></li>
						<li class="header_dropmemu mypage">
							
						<a href="/resources/ko/mypage" class="btn" onclick="GA_Event('공통','헤더_메뉴','마이페이지')">마이페이지</a>
							<div class="list">
								<ul>
									<li><a href="/resources/ko/mypage/order/myorders" onclick="GA_Event('공통','헤더_메뉴','마이페이지_주문조회')">주문조회<!-- 주문조회 --></a></li>
									<li><a href="/resources/ko/mypage/myGradeInfo" onclick="GA_Event('공통','헤더_메뉴','마이페이지_나의회원등급')">나의회원등급<!-- 온라인등급 --></a></li>
										<li><a href="/resources/ko/mypage/voucher" onclick="GA_Event('공통','헤더_메뉴','마이페이지_쿠폰조회')">쿠폰조회<!-- 쿠폰조회 --></a></li>
									<li><a href="/resources/ko/mypage/mypoint" onclick="GA_Event('공통','헤더_메뉴','마이페이지_마일리지조회')">마일리지조회<!-- 포인트조회 --></a></li>
										   <li><a href="/resources/ko/mypage/myEGiftCard" onclick="GA_Event('공통','헤더_메뉴','마이페이지_e-Gift Card')">e-Gift Card<!-- e-Gfit Card --></a></li>
									   <li><a href="/resources/ko/mypage/personInfomationChangePWCheck" onclick="GA_Event('공통','헤더_메뉴','마이페이지_회원정보변경')">회원정보변경<!-- 회원정보변경 --></a></li>
									<li><a href="/resources/ko/svcenter/mantomaninquiry" onclick="GA_Event('공통','헤더_메뉴','마이페이지_온라인상담')">온라인상담<!-- 온라인 상담 --></a></li>
									</ul>
							</div>
						</li>
...
<input type="hidden" name="CSRFToken" value="ef80554f-35d8-49d0-9154-b186d4566a0c" />
        ...
        <h1 class="logo logo1903">
            <a href="/resources/ko/main" onclick="GA_Event('공통', '로고', '상단');">thehandsome.com</a>
        </h1>
        ...
        >
            ...
            <li><a href="javascript:void(0);" class="gnb_brand" onclick="GA_Event('공통','GNB','브랜드');">브랜드<span class="arr">arrow</span></a>
                <div class="sub_back" style="background-color: #ffffff;">
                    <div class="sub_menu clearfix" >
                        ...
                        <li><strong>여성 브랜드</strong>
                                ...
                                <li ><input id="gnb_br_NEW_NORMAL_BRANDS_WE_BR01" name="gnb_br_ch" type="checkbox" class="checkboxEvent" title="TIME"  onclick="GA_Common('WE_brandLike',$(this));" value="NEW_NORMAL_BRANDS_WE#BR01#1" >                                    
                                    <label for="gnb_br_NEW_NORMAL_BRANDS_WE_BR01"></label><a href="/resources/ko/b/br01" onclick="GA_Common('WE_commonBrand',$(this));">TIME</a>
                                    </li>
                                    ...
                                    <label for="gnb_br_NEW_NORMAL_BRANDS_WE_BR02"></label><a href="/resources/ko/b/br02" onclick="GA_Common('WE_commonBrand',$(this));">MINE</a>
                                    </li>
                                    ...
                                    <label for="gnb_br_NEW_NORMAL_BRANDS_WE_BR19"></label><a href="/resources/ko/b/br19" onclick="GA_Common('WE_commonBrand',$(this));">LANVIN COLLECTION</a>
                                    </li>
                                    ...
                                    <label for="gnb_br_NEW_NORMAL_BRANDS_WE_BR03"></label><a href="/resources/ko/b/br03" onclick="GA_Common('WE_commonBrand',$(this));">SYSTEM</a>
                                    </li>
                                    ...
                                    <label for="gnb_br_NEW_NORMAL_BRANDS_WE_BR04"></label><a href="/resources/ko/b/br04" onclick="GA_Common('WE_commonBrand',$(this));">SJSJ</a>
                                    </li>
                                    ...
                                    <label for="gnb_br_NEW_NORMAL_BRANDS_WE_BR08"></label><a href="/resources/ko/b/br08" onclick="GA_Common('WE_commonBrand',$(this));">the CASHMERE</a>
                                    </li>
                                    ...
                                    <label for="gnb_br_NEW_NORMAL_BRANDS_WE_BR44"></label><a href="/resources/ko/b/br44" onclick="GA_Common('WE_commonBrand',$(this));">CLUB MONACO</a>
                                    </li>
                                    ...
                                    <label for="gnb_br_NEW_NORMAL_BRANDS_WE_BR43"></label><a href="/resources/ko/b/br43" onclick="GA_Common('WE_commonBrand',$(this));">OBZEE</a>
                                    </li>
                                    ...
                                    <label for="gnb_br_NEW_NORMAL_BRANDS_WE_BR31"></label><a href="/resources/ko/b/br31" onclick="GA_Common('WE_commonBrand',$(this));">LÄTT</a>
                                    </li>
                                    ...
                                    <label for="gnb_br_NEW_NORMAL_BRANDS_WE_BR45"></label><a href="/resources/ko/b/br45" onclick="GA_Common('WE_commonBrand',$(this));">O'2nd</a>
                                    </li>
                                    ...
                                    <label for="gnb_br_NEW_NORMAL_BRANDS_WE_BR61"></label><a href="/resources/ko/b/br61" onclick="GA_Common('WE_commonBrand',$(this));">oera</a>
                                    </li>
                                    </ul>
                            </li>
                        <li><strong>남성 브랜드</strong>
                                ...
                                <li ><input id="gnb_br_NEW_NORMAL_BRANDS_ME_BR06" name="gnb_br_ch" type="checkbox" class="checkboxEvent" title="TIME HOMME"  onclick="GA_Common('ME_brandLike',$(this));" value="NEW_NORMAL_BRANDS_ME#BR06#1" >                                    
                                    <label for="gnb_br_NEW_NORMAL_BRANDS_ME_BR06"></label><a href="/resources/ko/b/br06" onclick="GA_Common('ME_commonBrand',$(this));">TIME HOMME</a>
                                    </li>
                                    ...
                                    <label for="gnb_br_NEW_NORMAL_BRANDS_ME_BR07"></label><a href="/resources/ko/b/br07" onclick="GA_Common('ME_commonBrand',$(this));">SYSTEM HOMME</a>
                                    </li>
                                    ...
                                    <label for="gnb_br_NEW_NORMAL_BRANDS_ME_BR08"></label><a href="/resources/ko/b/br08" onclick="GA_Common('ME_commonBrand',$(this));">the CASHMERE</a>
                                    </li>
                                    ...
                                    <label for="gnb_br_NEW_NORMAL_BRANDS_ME_BR44"></label><a href="/resources/ko/b/br44" onclick="GA_Common('ME_commonBrand',$(this));">CLUB MONACO</a>
                                    </li>
                                    </ul>
                            </li>
                        <li><strong>편집 브랜드</strong>
                                ...
                                <li ><input id="gnb_br_NEW_NORMAL_BRANDS_ED_BR15" name="gnb_br_ch" type="checkbox" class="checkboxEvent" title="TOM GREYHOUND"  onclick="GA_Common('ED_brandLike',$(this));" value="NEW_NORMAL_BRANDS_ED#BR15#1" >                                    
                                    <label for="gnb_br_NEW_NORMAL_BRANDS_ED_BR15"></label><a href="/resources/ko/b/br15" onclick="GA_Common('ED_commonBrand',$(this));">TOM GREYHOUND</a>
                                    </li>
                                    ...
                                    <label for="gnb_br_NEW_NORMAL_BRANDS_ED_BR35"></label><a href="/resources/ko/b/br35" onclick="GA_Common('ED_commonBrand',$(this));">FOURM THE STORE</a>
                                    </li>
                                    ...
                                    <label for="gnb_br_NEW_NORMAL_BRANDS_ED_BR30"></label><a href="/resources/ko/b/br30" onclick="GA_Common('ED_commonBrand',$(this));">FOURM STUDIO</a>
                                    </li>
                                    ...
                                    <label for="gnb_br_NEW_NORMAL_BRANDS_ED_BR32"></label><a href="/resources/ko/b/br32" onclick="GA_Common('ED_commonBrand',$(this));">FOURM MEN'S LOUNGE</a>
                                    </li>
                                    ...
                                    <label for="gnb_br_NEW_NORMAL_BRANDS_ED_BR16"></label><a href="/resources/ko/b/br16" onclick="GA_Common('ED_commonBrand',$(this));">MUE</a>
                                    </li>
                                    ...
                                    <label for="gnb_br_NEW_NORMAL_BRANDS_ED_BR47"></label><a href="/resources/ko/b/br47" onclick="GA_Common('ED_commonBrand',$(this));">H : SCENE</a>
                                    </li>
                                    ...
                                    <label for="gnb_br_NEW_NORMAL_BRANDS_ED_BR62"></label><a href="/resources/ko/b/br62" onclick="GA_Common('ED_commonBrand',$(this));">Liquides Perfume Bar<i class="ico-new">new</i></a>
                                    </li>
                                    </ul>
                            </li>
                        <li><strong>해외 브랜드</strong>
                                ...
                                <li ><input id="gnb_br_NEW_NORMAL_BRANDS_OS_BR37" name="gnb_br_ch" type="checkbox" class="checkboxEvent" title="ROCHAS"  onclick="GA_Common('OS_brandLike',$(this));" value="NEW_NORMAL_BRANDS_OS#BR37#1" >                                    
                                    <label for="gnb_br_NEW_NORMAL_BRANDS_OS_BR37"></label><a href="/resources/ko/c/br37/br37" onclick="GA_Common('OS_commonBrand',$(this));">ROCHAS</a>
                                    </li>
                                    ...
                                    <label for="gnb_br_NEW_NORMAL_BRANDS_OS_BR41"></label><a href="/resources/ko/c/br41/br41" onclick="GA_Common('OS_commonBrand',$(this));">3.1 Phillip Lim</a>
                                    </li>
                                    ...
                                    <label for="gnb_br_NEW_NORMAL_BRANDS_OS_BR20"></label><a href="/resources/ko/c/br20/br20" onclick="GA_Common('OS_commonBrand',$(this));">LANVIN PARIS</a>
                                    </li>
                                    ...
                                    <label for="gnb_br_NEW_NORMAL_BRANDS_OS_BR21"></label><a href="/resources/ko/c/br21/br21" onclick="GA_Common('OS_commonBrand',$(this));">BALLY</a>
                                    </li>
                                    </ul>
                            </li>
                        <!-- #1141 - 카테고리 개편 - 메인 즐겨찾기 브랜드 레이어 -->
            ...
            <li><a href="/resources/ko/item/we" onclick="GA_Event('공통','GNB','여성');GA_Event('공통_카테고리','1DEPTH','여성');">여성<span class="arr">arrow</span></a>            
               <div class="sub_back" style="background-color: #ffffff;">
                           <div class="sub_menu clearfix">
                               <ul class="al_frt1">
                                   <li>
                                       <a href="/resources/ko/c/we" onclick="GA_Event('공통_카테고리','2DEPTH','여성_전체보기');">전체보기<!-- 전체보기 --></a>                                           
                                           </li>
                    <li ><a href="/resources/ko/c/we09/" onclick="GA_Event('공통_카테고리','2DEPTH','여성_SPECIAL SHOP*');">SPECIAL SHOP*</a>
                                    <ul class="clearfix">
                                        <li>
                                                <a href="/resources/ko/c/we09v/" onclick="GA_Event('공통_카테고리','3DEPTH','여성_SPECIAL SHOP*_MINE : CODE MINE E');">MINE : CODE MINE E</a>
                                                    </li>
                                        <li>
                                                <a href="/resources/ko/c/we09k/" onclick="GA_Event('공통_카테고리','3DEPTH','여성_SPECIAL SHOP*_LATT : EXCLUSIVE -THE LINES');">LATT : EXCLUSIVE -THE LINES</a>
                                                    </li>
                                        <li>
                                                <a href="/resources/ko/c/we093/" onclick="GA_Event('공통_카테고리','3DEPTH','여성_SPECIAL SHOP*_SYSTEM : JEANS');">SYSTEM : JEANS</a>
                                                    </li>
                                        <li>
                                                <a href="/resources/ko/c/we094/" onclick="GA_Event('공통_카테고리','3DEPTH','여성_SPECIAL SHOP*_SJSJ : SCENT IN TALES');">SJSJ : SCENT IN TALES</a>
                                                    </li>
                                        <li>
                                                <a href="/resources/ko/c/we098/" onclick="GA_Event('공통_카테고리','3DEPTH','여성_SPECIAL SHOP*_SYSTEM : PARIS PRESENTATION');">SYSTEM : PARIS PRESENTATION</a>
                                                    </li>
                                        <li>
                                                <a href="/resources/ko/c/we091/" onclick="GA_Event('공통_카테고리','3DEPTH','여성_SPECIAL SHOP*_OBZEE : ICONIC OBZEE');">OBZEE : ICONIC OBZEE</a>
                                                    </li>
                                        <li>
                                                <a href="/resources/ko/c/we09b/" onclick="GA_Event('공통_카테고리','3DEPTH','여성_SPECIAL SHOP*_O&amp;#039;2ND : 25TH ANNIV. MARIE ASSENAT ');">O'2ND : 25TH ANNIV. MARIE ASSENAT </a>
                                                    </li>
                                        <li>
                                                <a href="/resources/ko/c/we09j/" onclick="GA_Event('공통_카테고리','3DEPTH','여성_SPECIAL SHOP*_TOMGREYHOUND: THE GREY');">TOMGREYHOUND: THE GREY</a>
                                                    </li>
                                        <li>
                                                <a href="/resources/ko/c/we095/" onclick="GA_Event('공통_카테고리','3DEPTH','여성_SPECIAL SHOP*_FOURM THE STORE : PALETTE');">FOURM THE STORE : PALETTE</a>
                                                    </li>
                                        <li>
                                                <a href="/resources/ko/c/we096/" onclick="GA_Event('공통_카테고리','3DEPTH','여성_SPECIAL SHOP*_FOURM STUDIO : RE:STUDIO');">FOURM STUDIO : RE:STUDIO</a>
                                                    </li>
                                        <li>
                                                <a href="/resources/ko/c/we097/" onclick="GA_Event('공통_카테고리','3DEPTH','여성_SPECIAL SHOP*_LANVIN COLLECTION : IT. 1');">LANVIN COLLECTION : IT. 1</a>
                                                    </li>
                                        <li>
                                                <a href="/resources/ko/c/we092/" onclick="GA_Event('공통_카테고리','3DEPTH','여성_SPECIAL SHOP*_TIME : SIGNATURE SUIT');">TIME : SIGNATURE SUIT</a>
                                                    </li>
                                        <li>
                                                <a href="/resources/ko/c/we09q/" onclick="GA_Event('공통_카테고리','3DEPTH','여성_SPECIAL SHOP*_LATT : WITH 신민아');">LATT : WITH 신민아</a>
                                                    </li>
                                        </ul>
                                        </li>                                    
                                <!--  status2.last end -->
                <li ><a href="/resources/ko/c/we05/" onclick="GA_Event('공통_카테고리','2DEPTH','여성_아우터');">아우터</a>
                                    <ul class="clearfix">
                                        <li>
                                                <a href="/resources/ko/c/we051/" onclick="GA_Event('공통_카테고리','3DEPTH','여성_아우터_재킷');">재킷</a>
                                                    </li>
                                        <li>
                                                <a href="/resources/ko/c/we052/" onclick="GA_Event('공통_카테고리','3DEPTH','여성_아우터_점퍼');">점퍼</a>
                                                    </li>
                                        <li>
                                                <a href="/resources/ko/c/we015/" onclick="GA_Event('공통_카테고리','3DEPTH','여성_아우터_가디건/베스트');">가디건/베스트</a>
                                                    </li>
                                        <li>
                                                <a href="/resources/ko/c/we053/" onclick="GA_Event('공통_카테고리','3DEPTH','여성_아우터_트렌치 코트');">트렌치 코트</a>
                                                    </li>
                                        <li>
                                                <a href="/resources/ko/c/we054/" onclick="GA_Event('공통_카테고리','3DEPTH','여성_아우터_코트');">코트</a>
                                                    </li>
                                        <li>
                                                <a href="/resources/ko/c/we055/" onclick="GA_Event('공통_카테고리','3DEPTH','여성_아우터_다운/패딩');">다운/패딩</a>
                                                    </li>
                                        </ul>
                                        </li>                                    
                                <!--  status2.last end -->
                <li ><a href="/resources/ko/c/we01/" onclick="GA_Event('공통_카테고리','2DEPTH','여성_탑');">탑</a>
                                    <ul class="clearfix">
                                        <li>
                                                <a href="/resources/ko/c/we011/" onclick="GA_Event('공통_카테고리','3DEPTH','여성_탑_티셔츠');">티셔츠</a>
                                                    </li>
                                        <li>
                                                <a href="/resources/ko/c/we012/" onclick="GA_Event('공통_카테고리','3DEPTH','여성_탑_블라우스');">블라우스</a>
                                                    </li>
                                        <li>
                                                <a href="/resources/ko/c/we013/" onclick="GA_Event('공통_카테고리','3DEPTH','여성_탑_셔츠');">셔츠</a>
                                                    </li>
                                        <li>
                                                <a href="/resources/ko/c/we014/" onclick="GA_Event('공통_카테고리','3DEPTH','여성_탑_니트');">니트</a>
                                                    </li>
                                        </ul>
                                        </li>                                    
                                <!--  status2.last end -->
                <li ><a href="/resources/ko/c/we04/" onclick="GA_Event('공통_카테고리','2DEPTH','여성_드레스');">드레스</a>
                                    <ul class="clearfix">
                                        <li>
                                                <a href="/resources/ko/c/we041/" onclick="GA_Event('공통_카테고리','3DEPTH','여성_드레스_미니 드레스');">미니 드레스</a>
                                                    </li>
                                        <li>
                                                <a href="/resources/ko/c/we042/" onclick="GA_Event('공통_카테고리','3DEPTH','여성_드레스_미디 드레스');">미디 드레스</a>
                                                    </li>
                                        <li>
                                                <a href="/resources/ko/c/we043/" onclick="GA_Event('공통_카테고리','3DEPTH','여성_드레스_롱/맥시 드레스');">롱/맥시 드레스</a>
                                                    </li>
                                        </ul>
                                        </li>                                    
                                <!--  status2.last end -->
                <li ><a href="/resources/ko/c/we02/" onclick="GA_Event('공통_카테고리','2DEPTH','여성_팬츠');">팬츠</a>
                                    <ul class="clearfix">
                                        <li>
                                                <a href="/resources/ko/c/we021/" onclick="GA_Event('공통_카테고리','3DEPTH','여성_팬츠_캐주얼');">캐주얼</a>
                                                    </li>
                                        <li>
                                                <a href="/resources/ko/c/we022/" onclick="GA_Event('공통_카테고리','3DEPTH','여성_팬츠_포멀');">포멀</a>
                                                    </li>
                                        <li>
                                                <a href="/resources/ko/c/we023/" onclick="GA_Event('공통_카테고리','3DEPTH','여성_팬츠_데님');">데님</a>
                                                    </li>
                                        <li>
                                                <a href="/resources/ko/c/we024/" onclick="GA_Event('공통_카테고리','3DEPTH','여성_팬츠_쇼츠');">쇼츠</a>
                                                    </li>
                                        </ul>
                                        </li>                                    
                                <!--  status2.last end -->
                <li style="margin-right:0px"><a href="/resources/ko/c/we03/" onclick="GA_Event('공통_카테고리','2DEPTH','여성_스커트');">스커트</a>
                                    <ul class="clearfix">
                                        <li>
                                                <a href="/resources/ko/c/we031/" onclick="GA_Event('공통_카테고리','3DEPTH','여성_스커트_미니 스커트');">미니 스커트</a>
                                                    </li>
                                        <li>
                                                <a href="/resources/ko/c/we032/" onclick="GA_Event('공통_카테고리','3DEPTH','여성_스커트_펜슬 스커트');">펜슬 스커트</a>
                                                    </li>
                                        <li>
                                                <a href="/resources/ko/c/we033/" onclick="GA_Event('공통_카테고리','3DEPTH','여성_스커트_플레어 스커트');">플레어 스커트</a>
                                                    </li>
                                        <li>
                                                <a href="/resources/ko/c/we034/" onclick="GA_Event('공통_카테고리','3DEPTH','여성_스커트_롱/맥시 스커트');">롱/맥시 스커트</a>
                                                    </li>
                                        </ul>
                                        </li>                                    
                                </ul>
            ...
            <li><a href="/resources/ko/item/me" onclick="GA_Event('공통','GNB','남성');GA_Event('공통_카테고리','1DEPTH','남성');">남성<span class="arr">arrow</span></a>            
               <div class="sub_back" style="background-color: #ffffff;">
                           <div class="sub_menu clearfix">
                               <ul class="al_frt1">
                                   <li>
                                       <a href="/resources/ko/c/me" onclick="GA_Event('공통_카테고리','2DEPTH','남성_전체보기');">전체보기<!-- 전체보기 --></a>                                           
                                           </li>
                    <li ><a href="/resources/ko/c/me09/" onclick="GA_Event('공통_카테고리','2DEPTH','남성_SPECIAL SHOP*');">SPECIAL SHOP*</a>
                                    <ul class="clearfix">
                                        <li>
                                                <a href="/resources/ko/c/me09c/" onclick="GA_Event('공통_카테고리','3DEPTH','남성_SPECIAL SHOP*_SYSTEM HOMME : PLAYER LINE');">SYSTEM HOMME : PLAYER LINE</a>
                                                    </li>
                                        <li>
                                                <a href="/resources/ko/c/me094/" onclick="GA_Event('공통_카테고리','3DEPTH','남성_SPECIAL SHOP*_SYSTEM HOMME : PARIS PRESENTATION');">SYSTEM HOMME : PARIS PRESENTATION</a>
                                                    </li>
                                        <li>
                                                <a href="/resources/ko/c/me093/" onclick="GA_Event('공통_카테고리','3DEPTH','남성_SPECIAL SHOP*_SYSTEM HOMME : TYPE 2');">SYSTEM HOMME : TYPE 2</a>
                                                    </li>
                                        <li>
                                                <a href="/resources/ko/c/me091/" onclick="GA_Event('공통_카테고리','3DEPTH','남성_SPECIAL SHOP*_CLUB MONACO : PANTS ARCHIVE');">CLUB MONACO : PANTS ARCHIVE</a>
                                                    </li>
                                        <li>
                                                <a href="/resources/ko/c/me095/" onclick="GA_Event('공통_카테고리','3DEPTH','남성_SPECIAL SHOP*_TIME HOMME : ONLINE EXCLUSIVE');">TIME HOMME : ONLINE EXCLUSIVE</a>
                                                    </li>
                                        </ul>
                                        </li>                                    
                                <!--  status2.last end -->
                <li ><a href="/resources/ko/c/me03/" onclick="GA_Event('공통_카테고리','2DEPTH','남성_아우터');">아우터</a>
                                    <ul class="clearfix">
                                        <li>
                                                <a href="/resources/ko/c/me031/" onclick="GA_Event('공통_카테고리','3DEPTH','남성_아우터_재킷');">재킷</a>
                                                    </li>
                                        <li>
                                                <a href="/resources/ko/c/me032/" onclick="GA_Event('공통_카테고리','3DEPTH','남성_아우터_점퍼');">점퍼</a>
                                                    </li>
                                        <li>
                                                <a href="/resources/ko/c/me015/" onclick="GA_Event('공통_카테고리','3DEPTH','남성_아우터_가디건/베스트');">가디건/베스트</a>
                                                    </li>
                                        <li>
                                                <a href="/resources/ko/c/me033/" onclick="GA_Event('공통_카테고리','3DEPTH','남성_아우터_트렌치코트');">트렌치코트</a>
                                                    </li>
                                        <li>
                                                <a href="/resources/ko/c/me034/" onclick="GA_Event('공통_카테고리','3DEPTH','남성_아우터_코트');">코트</a>
                                                    </li>
                                        <li>
                                                <a href="/resources/ko/c/me035/" onclick="GA_Event('공통_카테고리','3DEPTH','남성_아우터_다운/패딩');">다운/패딩</a>
                                                    </li>
                                        </ul>
                                        </li>                                    
                                <!--  status2.last end -->
                <li ><a href="/resources/ko/c/me01/" onclick="GA_Event('공통_카테고리','2DEPTH','남성_탑');">탑</a>
                                    <ul class="clearfix">
                                        <li>
                                                <a href="/resources/ko/c/me011/" onclick="GA_Event('공통_카테고리','3DEPTH','남성_탑_티셔츠');">티셔츠</a>
                                                    </li>
                                        <li>
                                                <a href="/resources/ko/c/me012/" onclick="GA_Event('공통_카테고리','3DEPTH','남성_탑_셔츠');">셔츠</a>
                                                    </li>
                                        <li>
                                                <a href="/resources/ko/c/me013/" onclick="GA_Event('공통_카테고리','3DEPTH','남성_탑_니트');">니트</a>
                                                    </li>
                                        <li>
                                                <a href="/resources/ko/c/me014/" onclick="GA_Event('공통_카테고리','3DEPTH','남성_탑_스웨터');">스웨터</a>
                                                    </li>
                                        </ul>
                                        </li>                                    
                                <!--  status2.last end -->
                <li ><a href="/resources/ko/c/me02/" onclick="GA_Event('공통_카테고리','2DEPTH','남성_팬츠');">팬츠</a>
                                    <ul class="clearfix">
                                        <li>
                                                <a href="/resources/ko/c/me021/" onclick="GA_Event('공통_카테고리','3DEPTH','남성_팬츠_루즈/테이퍼드');">루즈/테이퍼드</a>
                                                    </li>
                                        <li>
                                                <a href="/resources/ko/c/me025/" onclick="GA_Event('공통_카테고리','3DEPTH','남성_팬츠_슬림/스트레이트');">슬림/스트레이트</a>
                                                    </li>
                                        <li>
                                                <a href="/resources/ko/c/me028/" onclick="GA_Event('공통_카테고리','3DEPTH','남성_팬츠_조거/트랙');">조거/트랙</a>
                                                    </li>
                                        <li>
                                                <a href="/resources/ko/c/me022/" onclick="GA_Event('공통_카테고리','3DEPTH','남성_팬츠_데님');">데님</a>
                                                    </li>
                                        <li>
                                                <a href="/resources/ko/c/me023/" onclick="GA_Event('공통_카테고리','3DEPTH','남성_팬츠_쇼츠');">쇼츠</a>
                                                    </li>
                                        </ul>
                                        </li>                                    
                                <!--  status2.last end -->
                <li style="margin-right:0px"><a href="/resources/ko/c/me04/" onclick="GA_Event('공통_카테고리','2DEPTH','남성_수트');">수트</a>
                                    <ul class="clearfix">
                                        <li>
                                                <a href="/resources/ko/c/me041/" onclick="GA_Event('공통_카테고리','3DEPTH','남성_수트_드레스셔츠');">드레스셔츠</a>
                                                    </li>
                                        <li>
                                                <a href="/resources/ko/c/me042/" onclick="GA_Event('공통_카테고리','3DEPTH','남성_수트_수트재킷');">수트재킷</a>
                                                    </li>
                                        <li>
                                                <a href="/resources/ko/c/me044/" onclick="GA_Event('공통_카테고리','3DEPTH','남성_수트_수트팬츠');">수트팬츠</a>
                                                    </li>
                                        </ul>
                                        </li>                                    
                                </ul>
            ...
            <li><a href="/resources/ko/c/as" onclick="GA_Event('공통','GNB','잡화');GA_Event('공통_카테고리','1DEPTH','잡화');">잡화<span class="arr">arrow</span></a>            
               <div class="sub_back" style="background-color: #ffffff;">
                           <div class="sub_menu clearfix">
                               <ul class="al_frt1">
                                   <li>
                                       <a href="/resources/ko/c/as" onclick="GA_Event('공통_카테고리','2DEPTH','잡화_전체보기');">전체보기<!-- 전체보기 --></a>                                           
                                           </li>
                    <li ><a href="/resources/ko/c/as01/" onclick="GA_Event('공통_카테고리','2DEPTH','잡화_여성슈즈');">여성슈즈</a>
                                    <ul class="clearfix">
                                        <li>
                                                <a href="/resources/ko/c/as011/" onclick="GA_Event('공통_카테고리','3DEPTH','잡화_여성슈즈_부츠');">부츠</a>
                                                    </li>
                                        <li>
                                                <a href="/resources/ko/c/as012/" onclick="GA_Event('공통_카테고리','3DEPTH','잡화_여성슈즈_로퍼/블로퍼');">로퍼/블로퍼</a>
                                                    </li>
                                        <li>
                                                <a href="/resources/ko/c/as013/" onclick="GA_Event('공통_카테고리','3DEPTH','잡화_여성슈즈_스니커즈');">스니커즈</a>
                                                    </li>
                                        <li>
                                                <a href="/resources/ko/c/as014/" onclick="GA_Event('공통_카테고리','3DEPTH','잡화_여성슈즈_플랫');">플랫</a>
                                                    </li>
                                        <li>
                                                <a href="/resources/ko/c/as015/" onclick="GA_Event('공통_카테고리','3DEPTH','잡화_여성슈즈_힐/슬링백');">힐/슬링백</a>
                                                    </li>
                                        <li>
                                                <a href="/resources/ko/c/as016/" onclick="GA_Event('공통_카테고리','3DEPTH','잡화_여성슈즈_샌들/슬라이드');">샌들/슬라이드</a>
                                                    </li>
                                        <li>
                                                <a href="/resources/ko/c/as017/" onclick="GA_Event('공통_카테고리','3DEPTH','잡화_여성슈즈_기타 슈즈');">기타 슈즈</a>
                                                    </li>
                                        </ul>
                                        </li>                                    
                                <!--  status2.last end -->
                <li ><a href="/resources/ko/c/as02/" onclick="GA_Event('공통_카테고리','2DEPTH','잡화_남성슈즈');">남성슈즈</a>
                                    <ul class="clearfix">
                                        <li>
                                                <a href="/resources/ko/c/as021/" onclick="GA_Event('공통_카테고리','3DEPTH','잡화_남성슈즈_부츠');">부츠</a>
                                                    </li>
                                        <li>
                                                <a href="/resources/ko/c/as022/" onclick="GA_Event('공통_카테고리','3DEPTH','잡화_남성슈즈_포멀슈즈');">포멀슈즈</a>
                                                    </li>
                                        <li>
                                                <a href="/resources/ko/c/as023/" onclick="GA_Event('공통_카테고리','3DEPTH','잡화_남성슈즈_스니커즈');">스니커즈</a>
                                                    </li>
                                        <li>
                                                <a href="/resources/ko/c/as024/" onclick="GA_Event('공통_카테고리','3DEPTH','잡화_남성슈즈_샌들/슬라이드');">샌들/슬라이드</a>
                                                    </li>
                                        <li>
                                                <a href="/resources/ko/c/as025/" onclick="GA_Event('공통_카테고리','3DEPTH','잡화_남성슈즈_기타 슈즈');">기타 슈즈</a>
                                                    </li>
                                        </ul>
                                        </li>                                    
                                <!--  status2.last end -->
                <li ><a href="/resources/ko/c/as03/" onclick="GA_Event('공통_카테고리','2DEPTH','잡화_여성백');">여성백</a>
                                    <ul class="clearfix">
                                        <li>
                                                <a href="/resources/ko/c/as031/" onclick="GA_Event('공통_카테고리','3DEPTH','잡화_여성백_토트백');">토트백</a>
                                                    </li>
                                        <li>
                                                <a href="/resources/ko/c/as032/" onclick="GA_Event('공통_카테고리','3DEPTH','잡화_여성백_숄더/크로스바디백');">숄더/크로스바디백</a>
                                                    </li>
                                        <li>
                                                <a href="/resources/ko/c/as033/" onclick="GA_Event('공통_카테고리','3DEPTH','잡화_여성백_클러치 백');">클러치 백</a>
                                                    </li>
                                        <li>
                                                <a href="/resources/ko/c/as034/" onclick="GA_Event('공통_카테고리','3DEPTH','잡화_여성백_기타 백');">기타 백</a>
                                                    </li>
                                        </ul>
                                        </li>                                    
                                <!--  status2.last end -->
                <li ><a href="/resources/ko/c/as04/" onclick="GA_Event('공통_카테고리','2DEPTH','잡화_남성백');">남성백</a>
                                    <ul class="clearfix">
                                        <li>
                                                <a href="/resources/ko/c/as041/" onclick="GA_Event('공통_카테고리','3DEPTH','잡화_남성백_토트백');">토트백</a>
                                                    </li>
                                        <li>
                                                <a href="/resources/ko/c/as042/" onclick="GA_Event('공통_카테고리','3DEPTH','잡화_남성백_숄더/크로스바디백');">숄더/크로스바디백</a>
                                                    </li>
                                        <li>
                                                <a href="/resources/ko/c/as043/" onclick="GA_Event('공통_카테고리','3DEPTH','잡화_남성백_클러치 백');">클러치 백</a>
                                                    </li>
                                        <li>
                                                <a href="/resources/ko/c/as044/" onclick="GA_Event('공통_카테고리','3DEPTH','잡화_남성백_기타 백');">기타 백</a>
                                                    </li>
                                        </ul>
                                        </li>                                    
                                <!--  status2.last end -->
                <li ><a href="/resources/ko/c/as05/" onclick="GA_Event('공통_카테고리','2DEPTH','잡화_머플러/스카프');">머플러/스카프</a>
                                    <ul class="clearfix">
                                        <li>
                                                <a href="/resources/ko/c/as051/" onclick="GA_Event('공통_카테고리','3DEPTH','잡화_머플러/스카프_머플러');">머플러</a>
                                                    </li>
                                        <li>
                                                <a href="/resources/ko/c/as052/" onclick="GA_Event('공통_카테고리','3DEPTH','잡화_머플러/스카프_스카프');">스카프</a>
                                                    </li>
                                        </ul>
                                        </li>                                    
                                <!--  status2.last end -->
                <li ><a href="/resources/ko/c/as06/" onclick="GA_Event('공통_카테고리','2DEPTH','잡화_주얼리');">주얼리</a>
                                    <ul class="clearfix">
                                        <li>
                                                <a href="/resources/ko/c/as061/" onclick="GA_Event('공통_카테고리','3DEPTH','잡화_주얼리_이어링/커프');">이어링/커프</a>
                                                    </li>
                                        <li>
                                                <a href="/resources/ko/c/as062/" onclick="GA_Event('공통_카테고리','3DEPTH','잡화_주얼리_목걸이');">목걸이</a>
                                                    </li>
                                        <li>
                                                <a href="/resources/ko/c/as063/" onclick="GA_Event('공통_카테고리','3DEPTH','잡화_주얼리_팔찌');">팔찌</a>
                                                    </li>
                                        <li>
                                                <a href="/resources/ko/c/as064/" onclick="GA_Event('공통_카테고리','3DEPTH','잡화_주얼리_반지');">반지</a>
                                                    </li>
                                        <li>
                                                <a href="/resources/ko/c/as065/" onclick="GA_Event('공통_카테고리','3DEPTH','잡화_주얼리_기타 주얼리');">기타 주얼리</a>
                                                    </li>
                                        </ul>
                                        </li>                                    
                                <!--  status2.last end -->
                <li style="margin-right:0px"><a href="/resources/ko/c/as07/" onclick="GA_Event('공통_카테고리','2DEPTH','잡화_기타 ACC');">기타 ACC</a>
                                    <ul class="clearfix">
                                        <li>
                                                <a href="/resources/ko/c/as071/" onclick="GA_Event('공통_카테고리','3DEPTH','잡화_기타 ACC_모자');">모자</a>
                                                    </li>
                                        <li>
                                                <a href="/resources/ko/c/as072/" onclick="GA_Event('공통_카테고리','3DEPTH','잡화_기타 ACC_양말');">양말</a>
                                                    </li>
                                        <li>
                                                <a href="/resources/ko/c/as073/" onclick="GA_Event('공통_카테고리','3DEPTH','잡화_기타 ACC_장갑');">장갑</a>
                                                    </li>
                                        <li>
                                                <a href="/resources/ko/c/as074/" onclick="GA_Event('공통_카테고리','3DEPTH','잡화_기타 ACC_벨트');">벨트</a>
                                                    </li>
                                        <li>
                                                <a href="/resources/ko/c/as075/" onclick="GA_Event('공통_카테고리','3DEPTH','잡화_기타 ACC_지갑');">지갑</a>
                                                    </li>
                                        <li>
                                                <a href="/resources/ko/c/as076/" onclick="GA_Event('공통_카테고리','3DEPTH','잡화_기타 ACC_헤어ACC');">헤어ACC</a>
                                                    </li>
                                        <li>
                                                <a href="/resources/ko/c/as077/" onclick="GA_Event('공통_카테고리','3DEPTH','잡화_기타 ACC_테크ACC');">테크ACC</a>
                                                    </li>
                                        <li>
                                                <a href="/resources/ko/c/as078/" onclick="GA_Event('공통_카테고리','3DEPTH','잡화_기타 ACC_기타소품');">기타소품</a>
                                                    </li>
                                        </ul>
                                        </li>                                    
                                </ul>
            ...
            <li><a href="/resources/ko/c/be" onclick="GA_Event('공통','GNB','뷰티');GA_Event('공통_카테고리','1DEPTH','뷰티');">뷰티<i class="ico-new">new</i><span class="arr">arrow</span></a>            
               <div class="sub_back" style="background-color: #ffffff;">
                           <div class="sub_menu clearfix">
                               <ul class="al_frt1">
                                   <li>
                                       <a href="/resources/ko/c/be" onclick="GA_Event('공통_카테고리','2DEPTH','뷰티_전체보기');">전체보기<!-- 전체보기 --></a>                                           
                                           </li>
                    <li ><a href="/resources/ko/c/be01/" onclick="GA_Event('공통_카테고리','2DEPTH','뷰티_스킨케어');">스킨케어</a>
                                    <ul class="clearfix">
                                        <li>
                                                <a href="/resources/ko/c/be011/" onclick="GA_Event('공통_카테고리','3DEPTH','뷰티_스킨케어_토너/에멀전/크림');">토너/에멀전/크림</a>
                                                    </li>
                                        <li>
                                                <a href="/resources/ko/c/be012/" onclick="GA_Event('공통_카테고리','3DEPTH','뷰티_스킨케어_세럼/앰플/오일/밤');">세럼/앰플/오일/밤</a>
                                                    </li>
                                        <li>
                                                <a href="/resources/ko/c/be013/" onclick="GA_Event('공통_카테고리','3DEPTH','뷰티_스킨케어_클렌징/스크럽/마스크');">클렌징/스크럽/마스크</a>
                                                    </li>
                                        </ul>
                                        </li>                                    
                                <!--  status2.last end -->
                <li ><a href="/resources/ko/c/be03/" onclick="GA_Event('공통_카테고리','2DEPTH','뷰티_바디/헤어케어');">바디/헤어케어</a>
                                    <ul class="clearfix">
                                        <li>
                                                <a href="/resources/ko/c/be031/" onclick="GA_Event('공통_카테고리','3DEPTH','뷰티_바디/헤어케어_핸드·바디로션/크림/오일');">핸드·바디로션/크림/오일</a>
                                                    </li>
                                        <li>
                                                <a href="/resources/ko/c/be032/" onclick="GA_Event('공통_카테고리','3DEPTH','뷰티_바디/헤어케어_핸드·바디워시/스크럽');">핸드·바디워시/스크럽</a>
                                                    </li>
                                        <li>
                                                <a href="/resources/ko/c/be033/" onclick="GA_Event('공통_카테고리','3DEPTH','뷰티_바디/헤어케어_샴푸/컨디셔너');">샴푸/컨디셔너</a>
                                                    </li>
                                        <li>
                                                <a href="/resources/ko/c/be034/" onclick="GA_Event('공통_카테고리','3DEPTH','뷰티_바디/헤어케어_트리트먼트/오일/스프레이');">트리트먼트/오일/스프레이</a>
                                                    </li>
                                        <li>
                                                <a href="/resources/ko/c/be035/" onclick="GA_Event('공통_카테고리','3DEPTH','뷰티_바디/헤어케어_기타 바디/헤어케어');">기타 바디/헤어케어</a>
                                                    </li>
                                        </ul>
                                        </li>                                    
                                <!--  status2.last end -->
                <li style="margin-right:0px"><a href="/resources/ko/c/be04/" onclick="GA_Event('공통_카테고리','2DEPTH','뷰티_향수');">향수</a>
                                    <ul class="clearfix">
                                        <li>
                                                <a href="/resources/ko/c/be041/" onclick="GA_Event('공통_카테고리','3DEPTH','뷰티_향수_향수');">향수</a>
                                                    </li>
                                        </ul>
                                        </li>                                    
                                </ul>
            ...
            <li><a href="/resources/ko/c/ls" onclick="GA_Event('공통','GNB','라이프스타일');GA_Event('공통_카테고리','1DEPTH','라이프스타일');">라이프스타일<span class="arr">arrow</span></a>            
               <div class="sub_back" style="background-color: #ffffff;">
                           <div class="sub_menu clearfix">
                               <ul class="al_frt1">
                                   <li>
                                       <a href="/resources/ko/c/ls" onclick="GA_Event('공통_카테고리','2DEPTH','라이프스타일_전체보기');">전체보기<!-- 전체보기 --></a>                                           
                                           </li>
                    <li ><a href="/resources/ko/c/ls01/" onclick="GA_Event('공통_카테고리','2DEPTH','라이프스타일_홈');">홈</a>
                                    <ul class="clearfix">
                                        <li>
                                                <a href="/resources/ko/c/ls011/" onclick="GA_Event('공통_카테고리','3DEPTH','라이프스타일_홈_패브릭');">패브릭</a>
                                                    </li>
                                        <li>
                                                <a href="/resources/ko/c/ls012/" onclick="GA_Event('공통_카테고리','3DEPTH','라이프스타일_홈_프래그런스');">프래그런스</a>
                                                    </li>
                                        <li>
                                                <a href="/resources/ko/c/ls013/" onclick="GA_Event('공통_카테고리','3DEPTH','라이프스타일_홈_데코레이션');">데코레이션</a>
                                                    </li>
                                        <li>
                                                <a href="/resources/ko/c/ls014/" onclick="GA_Event('공통_카테고리','3DEPTH','라이프스타일_홈_기타소품');">기타소품</a>
                                                    </li>
                                        </ul>
                                        </li>                                    
                                <!--  status2.last end -->
                <li ><a href="/resources/ko/c/ls02/" onclick="GA_Event('공통_카테고리','2DEPTH','라이프스타일_배스');">배스</a>
                                    <ul class="clearfix">
                                        <li>
                                                <a href="/resources/ko/c/ls022/" onclick="GA_Event('공통_카테고리','3DEPTH','라이프스타일_배스_욕실용품');">욕실용품</a>
                                                    </li>
                                        </ul>
                                        </li>                                    
                                <!--  status2.last end -->
                <li ><a href="/resources/ko/c/ls03/" onclick="GA_Event('공통_카테고리','2DEPTH','라이프스타일_키친');">키친</a>
                                    <ul class="clearfix">
                                        <li>
                                                <a href="/resources/ko/c/ls031/" onclick="GA_Event('공통_카테고리','3DEPTH','라이프스타일_키친_그릇');">그릇</a>
                                                    </li>
                                        <li>
                                                <a href="/resources/ko/c/ls032/" onclick="GA_Event('공통_카테고리','3DEPTH','라이프스타일_키친_보드/트레이');">보드/트레이</a>
                                                    </li>
                                        <li>
                                                <a href="/resources/ko/c/ls033/" onclick="GA_Event('공통_카테고리','3DEPTH','라이프스타일_키친_커트러리');">커트러리</a>
                                                    </li>
                                        <li>
                                                <a href="/resources/ko/c/ls034/" onclick="GA_Event('공통_카테고리','3DEPTH','라이프스타일_키친_커피/티');">커피/티</a>
                                                    </li>
                                        <li>
                                                <a href="/resources/ko/c/ls035/" onclick="GA_Event('공통_카테고리','3DEPTH','라이프스타일_키친_패브릭/냅킨');">패브릭/냅킨</a>
                                                    </li>
                                        <li>
                                                <a href="/resources/ko/c/ls036/" onclick="GA_Event('공통_카테고리','3DEPTH','라이프스타일_키친_기타소품');">기타소품</a>
                                                    </li>
                                        </ul>
                                        </li>                                    
                                <!--  status2.last end -->
                <li ><a href="/resources/ko/c/ls04/" onclick="GA_Event('공통_카테고리','2DEPTH','라이프스타일_데스크');">데스크</a>
                                    <ul class="clearfix">
                                        <li>
                                                <a href="/resources/ko/c/ls041/" onclick="GA_Event('공통_카테고리','3DEPTH','라이프스타일_데스크_문구');">문구</a>
                                                    </li>
                                        <li>
                                                <a href="/resources/ko/c/ls043/" onclick="GA_Event('공통_카테고리','3DEPTH','라이프스타일_데스크_기타소품');">기타소품</a>
                                                    </li>
                                        </ul>
                                        </li>                                    
                                <!--  status2.last end -->
                <li ><a href="/resources/ko/c/ls06/" onclick="GA_Event('공통_카테고리','2DEPTH','라이프스타일_키즈');">키즈</a>
                                    <ul class="clearfix">
                                        <li>
                                                <a href="/resources/ko/c/ls061/" onclick="GA_Event('공통_카테고리','3DEPTH','라이프스타일_키즈_의류');">의류</a>
                                                    </li>
                                        <li>
                                                <a href="/resources/ko/c/ls062/" onclick="GA_Event('공통_카테고리','3DEPTH','라이프스타일_키즈_잡화');">잡화</a>
                                                    </li>
                                        </ul>
                                        </li>                                    
                                <!--  status2.last end -->
                <li style="margin-right:0px"><a href="/resources/ko/c/ls05/" onclick="GA_Event('공통_카테고리','2DEPTH','라이프스타일_펫');">펫</a>
                                    <ul class="clearfix">
                                        <li>
                                                <a href="/resources/ko/c/ls051/" onclick="GA_Event('공통_카테고리','3DEPTH','라이프스타일_펫_패션');">패션</a>
                                                    </li>
                                        <li>
                                                <a href="/resources/ko/c/ls052/" onclick="GA_Event('공통_카테고리','3DEPTH','라이프스타일_펫_기타소품');">기타소품</a>
                                                    </li>
                                        </ul>
                                        </li>                                    
                                </ul>
        ...
        <ul class="cate_m cate_banner gnbul2" id="cate_m_main" style="float:right;">
            <li><a href="/resources/ko/magazine/exhibitions" onclick="GA_Event('공통','GNB','기획전');">기획전<!-- 기획전 --></a></li>
            <li><a href="/resources/ko/magazine/events" onclick="GA_Event('공통','GNB','이벤트');">이벤트</a></li>
            <!-- THE 매거진 수정 200330 -->
            <li>
                <a href="/resources/ko/magazine/submain" class="magazine1803" onclick="GA_Event('공통','GNB','THE 매거진');">THE 매거진<!-- 매거진 --><span class="arr">arrow</span></a>
                <div class="sub_back" style="background-color: #ffffff;">
                    <div class="sub_menu clearfix newtmzbox">
                        <ul class="the_maga_sublist">
                            <li><a href="/resources/ko/magazine/submain">전체보기</a>
                                <ul>
                                    <li><a href="/resources/ko/magazine/coverstory">커버스토리</a></li>
                                    <li><a href="/resources/ko/magazine/weeklypick">위클리 픽</a></li>
                                    <li><a href="/resources/ko/magazine/selection">셀렉션</a></li>
                                    <li><a href="/resources/ko/magazine/styleguide">스타일 가이드</a></li>
                                    <li><a href="/resources/ko/magazine/some">#SOME</a></li>
                                    <li><a href="/resources/ko/magazine/news">뉴스 </a></li>
                                </ul>
                            </li>
                        </ul>
                        <div class="img_themaga_sub">
                        <a href="/resources/ko/magazine/editorials/8806021781576" >
...
<a href="/resources/ko/magazine/editorials/8805989046344" >
...
<a href="/resources/ko/magazine/editorials/8805989013576" >
											<img class="amc_img" src="http://cdn.thehandsome.com/mobile/editorial/list/banner/20220427_37621063827637048_ko.jpg" alt="" />
											    <p>
			                                    <strong>커버스토리</strong>
			                                    <span>타임옴므가 꿈꾸는 여름</span>
			                                </p>
			                            </a>
</div>
                    </div>
            ...
            <!-- // THE 매거진 수정 200330 -->
            <!-- 20210319 편집샵 추가 -->
            <li ><a href="/resources/ko/ed/edMain" onclick="GA_Event('공통','GNB','편집샵');">편집샵</a></li>
            <!-- 20200710 룩북 추가 -->
            <li><a href="/resources/ko/magazine/lookbook">룩북</a></li>
            <li><a href="/resources/ko/ou/outletMain" onclick="GA_Event('공통','GNB','아울렛');">아울렛*</a></li>
        </ul>
        </div>
<!-- 첫번째 c:if -->
    ...
    <div class="util_menu util_menu1803">
        <ul class="clearfix">
            ...
            <li><a href="/resources/ko/mypage/myWish" onclick="GA_Event('공통','유틸_메뉴','위시리스트');"><span class="ico wishlist">wish list</span> <span class="count">(<span id="wishlistCount">0</span>)</span></a></li>
            <li><a href="/resources/ko/shoppingbag" onclick="GA_Event('공통','유틸_메뉴','쇼핑백');"><span class="ico cart">장바구니</span> <span class="count">(<span id="cartCount">0</span>)</span></a></li>
            </ul>
    </div>
  </div>  
    <!-- //201803 util menu -->
...
getNewsList("/resources/ko/magazine");


// 2022.03.29 푸터 공지사항 추가
getFooterNotices("/resources/ko/svcenter");


function moveMobile(){
// 	location.href = location.href.replace("?uiel=Desktop", "") + "?uiel=Mobile";
	location.href = "/resources/ko/?uiel=Mobile";
}
...
<li><a href="/resources/ko/svcenter/asguide" onclick="GA_Event('공통','푸터_메뉴','반품&환불안내');">반품&amp;환불안내</a></li>
					...
					<ul class="clearfix">
					   <li><a href="/resources/ko/member/login" onclick="GA_Event('공통','푸터_메뉴','로그인');">로그인</a></li>
