				...
				<div class="top_nav_wrap clearfix">
					<div class="brand_menu brand_menu1903">
						<ul class="clearfix">
							...
							<p class="brand_menu_guide_text">관리자 계정으로 로그인되었습니다.</p>
						</ul>
					</div>
					...
					<div class="util_menu" style="display: block;">
						<ul class="clearfix">
							<!-- 관리자 계정의 세션인 경우 (황명하) -->
							<li><a>관리자 ${sessionScope.user.mname}님</a></li>
							<li><a href="/member/logout"
								onclick="GA_Event('공통','헤더_메뉴','로그아웃')">로그아웃 <!-- 로그아웃 --></a></li>
							<li class="header_dropmemu mypage"><a
								href="/admin/adminpage" class="btn"
								onclick="GA_Event('공통','헤더_메뉴','마이페이지')">관리자페이지</a>

								<div class="list">
									<ul>
										<li><a href="/admin/adminpage">주문관리<!-- 주문조회 --></a></li>
										<li><a href="/admin/voucher">쿠폰관리<!-- 쿠폰조회 --></a></li>
									</ul>
								</div></li>
