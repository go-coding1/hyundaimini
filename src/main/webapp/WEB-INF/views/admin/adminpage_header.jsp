...
<link rel="stylesheet" type="text/css" href="/resources/_ui/desktop/common/css/font_443.css" media="all">
    <link rel="stylesheet" type="text/css" href="/resources/_ui/desktop/common/css/common.css?20220401" media="all">
<link rel="stylesheet" type="text/css" href="/resources/_ui/desktop/common/css/layout.css?20220331" media="all">
<link rel="stylesheet" type="text/css" href="/resources/_ui/desktop/common/css/popup.css?20210225" media="all">
...
<script type="text/javascript">
		...
		var ACC = { config: {} };
			...
			ACC.config.CSRFToken = "1ca503cd-f035-4118-8b48-9355905e6a1d";
...
<script type="text/javascript" src="/resources/_ui/desktop/common/js/common_function.js?20220411"></script>
...
// 								html.push('<li><a href="http://www.thehyundai.com/front/dpm/myShopHome.thd?bfp=Ref_Handsome">트렌드샵</a></li>');
	...
	<form id="CSRFForm" action="/ko/member/login" method="post"><div>
...
function callChatbot(token, talkId) {
    if(token == null) {
        $.ajax({
            ...
            data: {"CSRFToken":"1ca503cd-f035-4118-8b48-9355905e6a1d"},
            async : false,
            success:function(data){
                    ...
                    <div class="data_react">
                        ...
                        <div class="search_tab">
                            ...
                            <form id="searchStyle" name="searchStyle" action="/ko/hssearch/searchCount" method="post" onsubmit="return false;">
                                ...
                                <input type="hidden" name="collection" value="">
                                <input type="hidden" id="CSRFToken" name="CSRFToken" value="1ca503cd-f035-4118-8b48-9355905e6a1d">
...
<!--                                     <p><span>"<span id="autocomplete_query"></span>&#32;"</span>에 대한 주요 검색 결과</p> -->
                ...
                <div class="util_menu" style="display:block;">
					<ul class="clearfix">
						...
						<!-- 유저세션이 없는경우 (황명하) -->
						<li><a href="/member/login" onclick="GA_Event('공통','헤더_메뉴','로그인')">로그인<!-- 로그인 --></a></li>
						<li class="header_dropmemu mypage">
						<a href="/member/login" class="btn" onclick="GA_Event('공통','헤더_메뉴','마이페이지')">마이페이지</a>	 	
						</c:when>				
						<c:otherwise>
						<!-- 유저세션이 있는 경우 (황명하) -->
						<li><a>관리자 ${sessionScope.user.mname}님</a></li>
						<li><a href="/member/logout" onclick="GA_Event('공통','헤더_메뉴','로그아웃')">로그아웃 <!-- 로그아웃 --></a></li>	 	
						<li class="header_dropmemu mypage">
						<a href="/admin/adminpage" class="btn" onclick="GA_Event('공통','헤더_메뉴','마이페이지')">관리자페이지</a>
						</c:otherwise>
						</c:choose>
							<div class="list">
								<ul>
