...
<meta name="naver-site-verification"
	content="2f9358e1e36605519854a595f243f0171519dd1d" /resources />
...
<link rel="stylesheet" type="text/css"
	href="/resources/_ui/desktop/common/css/common.css" media="all" />
<link rel="stylesheet" type="text/css"
	href="/resources/_ui/desktop/common/css/layout.css" media="all" />
<link rel="stylesheet" type="text/css"
	href="/resources/_ui/desktop/common/css/popup.css" media="all" />
<link rel="stylesheet" type="text/css"
...
<link rel="stylesheet" type="text/css"
	href="/resources/_ui/desktop/common/css/footer.css" media="all" />
<link rel="stylesheet" type="text/css"
	href="/resources/_ui/desktop/common/css/contents.css" media="all" />
...
<script type="text/javascript"
	src="/resources/_ui/shared/js/siteoverlay.js"></script>
<script type="text/javascript"
...
<script type="text/javascript"
	src="/resources/_ui/desktop/common/js/netfunnel.js" charset="UTF-8"></script>
<script type="text/javascript"
	src="/resources/_ui/desktop/common/js/netfunnel_skin.js"
	...
	function getPageDepth() {
		...
		if (target_url.substring(target_url.indexOf("/resources/ko/") + 4) == "") {
			returnDepth = "메인";
				...
				.substring(target_url.indexOf("/resources/ko") + 3) == "") {
			returnDepth = "메인";
			...
			if (target_url.toLowerCase().substring(
					target_url.indexOf("/resources/c/") + 3).indexOf("br") > -1) {
				returnDepth = "브랜드";
			} else {
				returnDepth = "";
			}
	...
	function getGAPageTitle(oneDepthPage) {
		...
		if (target_url.substring(target_url.indexOf("/resources/ko/") + 4) == "") {
			...
			returnTitle = oneDepthPage + ">룩북>리스트";
				...
				.indexOf("/resources/b//lookBookDetail?lookBookCode=") > -1) {
			...
			returnTitle = oneDepthPage + ">재입고 알림";
				...
				.indexOf("/resources/mypage/personInfomationChangePWCheck") > -1) {
		...
		} else if (target_url.endsWith("/resources/ko/mypage/",
				target_url.length)) {
			returnTitle = oneDepthPage + ">메인";
		} else if (target_url.endsWith("/resources/ko/mypage",
				target_url.length)) {
			...
			returnTitle = oneDepthPage + ">룩북>리스트";
				...
				.indexOf("/resources/magazine/newsDetailtemplatetype") > -1) {
			...
			returnTitle = oneDepthPage + ">수선진행조회";
				...
				.indexOf("/resources/svcenter/serviceguide?targetSlide=0") > -1) {
			returnTitle = oneDepthPage + ">서비스소개>간편서비스";
		} else if (target_url
				.indexOf("/resources/svcenter/serviceguide?targetSlide=1") > -1) {
			returnTitle = oneDepthPage + ">서비스소개>스마트쇼핑";
		} else if (target_url
				.indexOf("/resources/svcenter/serviceguide?targetSlide=2") > -1) {
			...
			returnTitle = oneDepthPage + ">투자정보>IR";
				...
				.indexOf("/resources/footer/footerCorporatePartnership") > -1) {
			returnTitle = oneDepthPage + ">동반성장>소개";
		} else if (target_url
				.indexOf("/resources/footer/footerCoreFourPractices") > -1) {
			returnTitle = oneDepthPage + ">동반성장>4대 실천사항";
		} else if (target_url
				.indexOf("/resources/footer/footerCooperatorSelection") > -1) {
...
<script>
	...
	try {
		...
		(function(w, d, n, s, e, o) {
			...
			e.async = 1;
			e.charset = 'utf-8';
			e.src = '/resources//static.recopick.com/dist/production.min.js';
...
<body oncontextmenu='return false'>
	...
	<div class="loading_bar" id="loadingBarDiv" style="display: none;">
		<img src="/resources/_ui/desktop/common/images/common/loading.gif"
			alt="loading" /resources /> <span>�로딩중</span>
	</div>
	<!-- //Loading -->

	<form id="CSRFForm" action="/resources/ko/" method="post">
		<div>
			<input type="hidden" name="CSRFToken"
				value="ef80554f-35d8-49d0-9154-b186d4566a0c" />
		</div>
	</form>
	<!-- headerWrap -->
	<div id="headerWrap">
		<div class="header header_fixed header_main1903">
					...
					if (token == null) {
						$
								.ajax({
									...
									data : {
										"CSRFToken" : "ef80554f-35d8-49d0-9154-b186d4566a0c"
									},
									async : false,
									success : function(data) {
			...
			<script type="text/javascript">
						...
						.ready(
								function() {
									...
									$('#gnbsearch')
											.click(
													function() {
														...
														if (searchwords != "") {
															location.href = "/resources/ko/hssearch?searchwords="
																	+ searchwords;
														} else {
															$('#gnbsearchwords')
																	.val("");
									...
									var ssoUrl = "https://sso.h-point.co.kr:29865"
											+ "/resources/co/setSsoReqJSONP.hd";
				...
				function language(isoCode) {
					if (location.href.indexOf("/resources/handsome/") > -1) {
						...
						$.ajax({
							type : "post",
							url : "/resources/ko/_s/language" + "?" + "code="
									+ isoCode,
							dataType : "json",
			...
			<form id="autologinForm" name="autologinForm"
				action="/resources/ko/hp/autologin" method="get">
				...
				<div class="top_nav_wrap clearfix">
					...
					<div class="gnb_sh_wrap" style="display: none;">
						...
						<div class="gnb_sh_box">
							<input type="text" class="input" id="gnbsearchwords"
								...
								/resources /> <a href="javascript:void(0);" id="gnbsearch">검색</a>
						</div>
						<!-- //search box -->
						<!-- search result -->
					...
					<div class="search_box_wrap sbw1803" id="searchBox">
						<form name="search" id="search"
							action="/resources/ko/hssearch/searchCount" method="post"
							onsubmit="return false;">
							<input type="hidden" name="CSRFToken"
								value="ef80554f-35d8-49d0-9154-b186d4566a0c" /> <input
						...
						<div class="data_react">
							...
							<div class="search_tab">
								...
								<form id="searchStyle" name="searchStyle"
									action="/resources/ko/hssearch/searchCount" method="post"
									onsubmit="return false;">
									<input type="hidden" name="query" value="" /resources /> <input
										type="hidden" name="collection" value="" /resources /> <input
										type="hidden" id="CSRFToken" name="CSRFToken"
										value="ef80554f-35d8-49d0-9154-b186d4566a0c" /> <input
										type="hidden" id="searchStyleYn" name="searchStyleYn"
										value="searchStyle" /resources />
								</form>
						...
						<ul class="clearfix">
							<c:choose>
								<c:when test="${empty sessionScope.user}">
									...
									<li class="header_dropmemu mypage"><a href="/member/login"
										class="btn" onclick="GA_Event('공통','헤더_메뉴','마이페이지')">마이페이지</a>
								</c:when>
								<c:otherwise>
									<!-- 유저세션이 있는 경우 (황명하) -->
									<li><a>안녕하세요! ${sessionScope.user.mname}님</a></li>
									<li><a href="/member/logout"
										onclick="GA_Event('공통','헤더_메뉴','로그아웃')">로그아웃 <!-- 로그아웃 --></a></li>
									<li class="header_dropmemu mypage"><a
										href="/member/mypage" class="btn"
										onclick="GA_Event('공통','헤더_메뉴','마이페이지')">마이페이지</a>
								</c:otherwise>
							</c:choose>
							<div class="list">
								<ul>
									<li><a href="/resources/ko/mypage/order/myorders"
										onclick="GA_Event('공통','헤더_메뉴','마이페이지_주문조회')">주문조회<!-- 주문조회 --></a></li>
									<li><a href="/resources/ko/mypage/myGradeInfo"
										onclick="GA_Event('공통','헤더_메뉴','마이페이지_나의회원등급')">나의회원등급<!-- 온라인등급 --></a></li>
									<li><a href="/resources/ko/mypage/voucher"
										onclick="GA_Event('공통','헤더_메뉴','마이페이지_쿠폰조회')">쿠폰조회<!-- 쿠폰조회 --></a></li>
									<li><a href="/resources/ko/mypage/mypoint"
										onclick="GA_Event('공통','헤더_메뉴','마이페이지_마일리지조회')">마일리지조회<!-- 포인트조회 --></a></li>
									<li><a href="/resources/ko/mypage/myEGiftCard"
										onclick="GA_Event('공통','헤더_메뉴','마이페이지_e-Gift Card')">e-Gift
											Card<!-- e-Gfit Card -->
									</a></li>
									<li><a
										href="/resources/ko/mypage/personInfomationChangePWCheck"
										onclick="GA_Event('공통','헤더_메뉴','마이페이지_회원정보변경')">회원정보변경<!-- 회원정보변경 --></a></li>
									<li><a href="/resources/ko/svcenter/mantomaninquiry"
			...
			<div class="gnbwarp com clearfix">
				...
				<div class="gnb_nav gnb_nav1903 hscene1906 hscene1910">
					...
					<ul class="cate_m cate_banner gnbul1" id="cate_m_main">
						...
						<li><a
							href="/product/productList?cateNo=100&pageNum=1&amount=12&level=1"
							...
							<div class="sub_back" style="background-color: #ffffff;">
								<div class="sub_menu clearfix">
									<ul class="al_frt1">
										...
										<!--  status2.last end -->
										<li><a
											href="/product/productList?cateNo=101&pageNum=1&amount=12&level=2">아우터</a>
											<ul class="clearfix">
												<li><a
													href="/product/productList?cateNo=1011&pageNum=1&amount=12&level=3">재킷</a>
												</li>
												<li><a
													href="/product/productList?cateNo=1012&pageNum=1&amount=12&level=3">점퍼</a>
												</li>
					...
					<ul class="cate_m cate_banner gnbul2" id="cate_m_main"
						style="float: right;">
						<li><a href="/resources/ko/magazine/exhibitions"
							onclick="GA_Event('공통','GNB','기획전');">기획전<!-- 기획전 --></a></li>
						<li><a href="/resources/ko/magazine/events"
							onclick="GA_Event('공통','GNB','이벤트');">이벤트</a></li>
						<!-- THE 매거진 수정 200330 -->
						<li><a href="/resources/ko/magazine/submain"
							class="magazine1803" onclick="GA_Event('공통','GNB','THE 매거진');">THE
								매거진<!-- 매거진 --> <span class="arr">arrow</span>
						</a>
							<div class="sub_back" style="background-color: #ffffff;">
								<div class="sub_menu clearfix newtmzbox">
									<ul class="the_maga_sublist">
										<li><a href="/resources/ko/magazine/submain">전체보기</a>
											<ul>
												...
												<li><a href="/resources/ko/magazine/weeklypick">위클리
														픽</a></li>
												<li><a href="/resources/ko/magazine/selection">셀렉션</a></li>
												<li><a href="/resources/ko/magazine/styleguide">스타일
														가이드</a></li>
									...
									<div class="img_themaga_sub">
										...
										</a> <a href="/resources/ko/magazine/editorials/8805989046344">
											<img class="amc_img"
										...
										</a> <a href="/resources/ko/magazine/editorials/8805989013576">
											<img class="amc_img"
											src="http://cdn.thehandsome.com/mobile/editorial/list/banner/20220427_37621063827637048_ko.jpg"
											alt="" />
											<p>
												<strong>커버스토리</strong> <span>타임옴므가 꿈꾸는 여름</span>
											</p>
										</a>
									</div>
								</div>
